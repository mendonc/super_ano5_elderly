...
import Tratamento from '../../assets/Tratamento.svg';
    ...
    return (
        <TabArea>
            <TabItem onPress={()=>goTo('Home')}>
                <HomeIcon width="40" height="40" fill={state.index === 0 ? "#25306b" : "#000000"} />   
                <TabText active={state.index === 0}>Home</TabText>   
            </TabItem>
            <TabItem onPress={()=>goTo('BemEstar')}>
                <BemEstarIcon width="40" height="40" fill={state.index === 1 ? "#25306b" : "#000000"} />
                <TabText active={state.index === 1}>BemEstar</TabText>
            </TabItem>
            <TabItem onPress={()=>goTo('Tratamento')}>
                <Tratamento width="40" height="40" fill={state.index === 2 ? "#25306b" : "#000000"} />
                <TabText active={state.index === 2}>Tratamento</TabText>
            </TabItem>
