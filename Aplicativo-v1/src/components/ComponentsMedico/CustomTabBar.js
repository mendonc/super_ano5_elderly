    ...
    return (
        <TabArea>
            <TabItem onPress={()=>goTo('Home')}>
                ...
                <TabText active={state.index === 0}>Bem-estar</TabText>   
            </TabItem>
            ...
            <TabItem onPress={()=>goTo('Calendario')}>
                <CalendarioIcon width="40" height="40" fill={state.index === 2 ? "#25306b" : "#000000"} />
                <TabText active={state.index === 2}>Calendário</TabText>
            </TabItem>
